...
: init
    init-run 0= if
        ...
        s" 192.168.100.25" 1502
        modbus-new-net abort" modbus-new-net failed" to ctx 
\         s" /dev/ttyUSB2" modbus-new-rtu abort" modbus-new-rtu failed" to ctx 
...
: modbus
    ...
    ctx 0x10 2 ptr modbus-read-registers abort" Read failed"
    ptr 20 dump
;
